...
public:
	...
	*/
	/* marked by quxy, for s60v2 not allow use static data, so just use default value
...
private:
	...
	static const bool condenseWhiteSpace;
};
...
public:
	...
	*/
	...
	const TiXmlElement* SearchFirstChildElement( const char * _value ) const;
	TiXmlElement* SearchFirstChildElement( const char * _value ) {
		return const_cast< TiXmlElement* >( (const_cast< const TiXmlNode* >(this))->SearchFirstChildElement( _value ) );
	}
