...
<div class="inside">
	...
	<div style=" height:89px; width:510px; margin:17px 0 0 0; ">
		...
		<a href="LowFare.aspx" style=" margin:4px 0 0 23px;" class="inside_nav4 inside_anv_icon"></a>
		<a href="News_List.aspx?News_ClassID=1" style=" margin:4px 0 0 23px;" class="inside_nav5 inside_anv_icon"></a>
		<a href="Knows_List.aspx?Knows_ClassID=3" style=" margin:4px 0 0 23px;" class="inside_nav6 inside_anv_icon"></a>
