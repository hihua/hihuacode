...
public class ModelAdmin extends ModelBase {
	...
	public List<Map<String, Object>> adminSelectAll() {
		...
		try {
			pre = mConn.prepareStatement("{call p_admin_select_all()}");
	...
	public boolean adminDeleteParent(final int adminId) {
		PreparedStatement pre;
		
		try {
			pre = mConn.prepareStatement("{call p_admin_delete_parent(?)}");
		} catch (SQLException e) {				
			Log.log(Level.ERROR, e.getMessage(), e);			
			return false;
		}
	...
	public boolean adminUpdateDesc(final int adminId, final String adminDesc) {
		PreparedStatement pre;
		
		try {
			pre = mConn.prepareStatement("{call p_admin_update_desc(?,?)}");
		} catch (SQLException e) {				
			Log.log(Level.ERROR, e.getMessage(), e);			
			return false;
		}
	...
	public Map<String, Object> adminSelectId(final int adminId) {
		PreparedStatement pre;
		
		try {
			pre = mConn.prepareStatement("{call p_admin_select_id(?)}");
		} catch (SQLException e) {				
			Log.log(Level.ERROR, e.getMessage(), e);			
			return null;
		}
	...
	public List<Map<String, Object>> adminSelectParent(final int adminParent) {
		PreparedStatement pre;
		
		try {
			pre = mConn.prepareStatement("{call p_admin_select_parent(?)}");
		} catch (SQLException e) {				
			Log.log(Level.ERROR, e.getMessage(), e);			
			return null;
		}
	...
	public boolean adminUpdatePassword(final int adminId, final String adminPassword) {
		PreparedStatement pre;
		
		try {
			pre = mConn.prepareStatement("{call p_admin_update_password(?,?)}");
		} catch (SQLException e) {				
			Log.log(Level.ERROR, e.getMessage(), e);			
			return false;
		}
