...
public abstract class ModelBase {
	...
	protected void closeStmt(final PreparedStatement stmt) {
		if (stmt == null)
			return;
	...
	protected void closeRs(final ResultSet rs) {
		if (rs == null)
			return;
	...
	protected Map<String, Object> createField(final ResultSet rs) {		
