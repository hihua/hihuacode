<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Member_Detail.aspx.cs" Inherits="Web.Admin.Member_Detail" %>
            ...
            <div class="win_top">
		        ...
		        <div class="win_pic">
			        ...
			        <ul>
				        ...
				        <li id="Li2" class="win_pic_li2" style="height:22px; margin-bottom:-1px;" onmouseover="ShowDiv(this,2)" runat="server">查询消费记录</li>
			        </ul>
                </div>
	        </div>
	        <div id="foda1">
