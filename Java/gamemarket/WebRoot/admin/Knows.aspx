<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Knows.aspx.cs" Inherits="Web.Admin.Knows" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ActionSubmit(Action_ID, Knows_ID)
        {
            var URL = "Knows_Detail.aspx?Action_ID=" + Action_ID + "&Knows_ID=" + Knows_ID;                                
            switch (Action_ID)
            {
                case 1:
                    window.open(URL,"Knows","toolbar=no,menubar=no,location=no,status=no,resizable=yes,scrollbars=yes,width=1024px,height=700px");   
                    break;
	            ...
	            <tr bgcolor="#C0C0C0">
		            <td align="left">
		                ...
		                <asp:DropDownList ID="Search_Method" runat="server">
	      	            ...
	      	            <asp:DropDownList ID="Knows_LanguageID" runat="server">
	  	            ...
	  	            <td align="right"><asp:Button ID="Knows_Add" runat="server" Text="  添加  " /></td>                    
	            </tr>
            </table>            
