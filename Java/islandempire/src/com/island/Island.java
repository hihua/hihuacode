	...
	public static List<IslandBuilding> parse(String response) {
		...
		if (arrays != null) {
			...
			for (int i = 0; i < arrays.size(); i++) {
				...
				Long subType = array.get("sub_type") != null ? array.getLong("sub_type") : null;
				...
				String moveDestroyStatus = array.get("move_destroy_status") != null ? array.getString("move_destroy_status") : null;
				...
				if (type.equals("Village")) {
					...
					islandVillage.setSubType(subType);
					...
					islandVillage.setMoveDestroyStatus(moveDestroyStatus);
				...
				if (type.equals("Town")) {
					...
					islandTown.setMoveDestroyStatus(moveDestroyStatus);
					islandTown.setHonorPointCanPlunder(array.get("honor_point_can_plunder") != null ? array.getLong("honor_point_can_plunder") : null);
					...
					islandTown.setOwnerHonorLevel(array.get("owner_honor_level") != null ? array.getLong("owner_honor_level") : null);
					islandTown.setOwnerHonorPoint(array.get("owner_honor_point") != null ? array.getLong("owner_honor_point") : null);
					islandTown.setOwnerScore(array.get("owner_score") != null ? array.getLong("owner_score") : null);
					islandTown.setCityWallStatus(array.get("city_wall_status") != null ? array.getLong("city_wall_status") : null);
					list.add(islandTown);
				}
			}
