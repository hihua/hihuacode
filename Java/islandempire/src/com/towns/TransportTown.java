	...
	public static TransportTown parse(String response) {
		...
		if (town.get("transport_queue") != null) {
			...
			for (int i = 0; i < arrays.size(); i++) {
				...
				transportQueue.setIronclad((array.get("ironclad") != null) ? array.getLong("ironclad") : null);
				transportQueue.setFrigate((array.get("frigate") != null) ? array.getLong("frigate") : null);
				transportQueue.setMusketman((array.get("musketman") != null) ? array.getLong("musketman") : null);
				transportQueue.setCatapult((array.get("catapult") != null) ? array.getLong("catapult") : null);
				transportQueue.setInfantry((array.get("infantry") != null) ? array.getLong("infantry") : null);
				transportQueue.setDestroyer((array.get("destroyer") != null) ? array.getLong("destroyer") : null);
				transportQueue.setScout((array.get("scout") != null) ? array.getLong("scout") : null);
				transportQueue.setPegasus((array.get("pegasus") != null) ? array.getLong("pegasus") : null);
				transportQueue.setBerserker((array.get("berserker") != null) ? array.getLong("berserker") : null);
				...
				transportQueue.setTargetIslandId((array.get("target_island_id") != null) ? array.getLong("target_island_id") : null);
		...
		if (town.get("soldiers") != null) {
			...
			for (int i = 0; i < arrays.size(); i++) {
				...
				if (soldier.getName().equals("pegasus")) {
					transportTown.setSoldierPegasus(soldier);
					continue;
				}
				
				if (soldier.getName().equals("berserker")) {
					transportTown.setSoldierBerserker(soldier);
					continue;
				}
				
				if (soldier.getName().equals("ironclad")) {
					transportTown.setSoldierIronclad(soldier);
					continue;
				}
			}
		}
