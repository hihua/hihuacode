...
public class AdapterMyAppBrowse extends BaseAdapter implements OnScrollListener {
	...
	public AdapterMyAppBrowse(Context context, ListView listView, List<EntityApp> list, OnClickListener onClick) {
		mContext = context;
		mListView = listView;
		mList = list;
		mOnClick = onClick;
