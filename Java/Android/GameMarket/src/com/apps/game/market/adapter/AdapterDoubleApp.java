...
public class AdapterDoubleApp extends AdapterBase implements RequestCallBackApp {	
	...
	public AdapterDoubleApp(Context context, ListView listView, RequestApp requestApp, OnClickListener onClick) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {		
		...
		if (convertView == null) {			
			...
			holder.setSize1((TextView) convertView.findViewById(R.id.app_size1));
			holder.setSize2((TextView) convertView.findViewById(R.id.app_size2));
			...
			holder.setRating1((RatingBar) convertView.findViewById(R.id.app_rating1));
			holder.setRating2((RatingBar) convertView.findViewById(R.id.app_rating2));
			holder.setScore1((TextView) convertView.findViewById(R.id.app_score1));
			holder.setScore2((TextView) convertView.findViewById(R.id.app_score2));			
			holder.setAction1((LinearLayout) convertView.findViewById(R.id.app_action1));
			holder.setAction2((LinearLayout) convertView.findViewById(R.id.app_action2));
			holder.setText1((TextView) convertView.findViewById(R.id.app_text1));
			holder.setText2((TextView) convertView.findViewById(R.id.app_text2));
			holder.setDownload1((ImageView) convertView.findViewById(R.id.app_download1));
			holder.setDownload2((ImageView) convertView.findViewById(R.id.app_download2));
