...
public class ViewColumnDouble extends ViewColumn implements RequestCallBackAd, CallBackScrollViewAd {
	...
	public ViewColumnDouble(Context context, ViewPager parent, ViewGroup layoutColumn, EntityColumn entityColumn, OnClickListener onClick, RequestCallBackInfo callBack) {		 
	...
	public void onSubColumn(final RequestApp request) {
		...
		mAdapter = new AdapterDoubleApp(mContext, mListView, request, mOnClick);
		mListView.setAdapter(mAdapter);	
	}
