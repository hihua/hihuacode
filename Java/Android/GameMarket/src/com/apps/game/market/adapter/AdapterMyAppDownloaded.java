...
import com.apps.game.market.viewholder.ViewHolderMyAppDownloaded;
...
public class AdapterMyAppDownloaded extends AdapterBase implements OnClickListener {	
	...
	public AdapterMyAppDownloaded(Context context, ListView listView, OnClickListener onClick, List<EntityApp> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {		
		ViewHolderMyAppDownloaded holder = null;
		if (convertView == null) {			
			holder = new ViewHolderMyAppDownloaded();
			convertView = mInflater.inflate(R.layout.myapp_downloaded, parent, false);
			holder.setLayout1((LinearLayout) convertView.findViewById(R.id.myapp_downloaded_layout1));
			holder.setLayout2((LinearLayout) convertView.findViewById(R.id.myapp_downloaded_layout2));			
			holder.setIcon1((ImageView) convertView.findViewById(R.id.myapp_downloaded_icon1));
			holder.setIcon2((ImageView) convertView.findViewById(R.id.myapp_downloaded_icon2));
			holder.setName1((TextView) convertView.findViewById(R.id.myapp_downloaded_name1));
			holder.setName2((TextView) convertView.findViewById(R.id.myapp_downloaded_name2));
			holder.setPrice1((TextView) convertView.findViewById(R.id.myapp_downloaded_price1));
			holder.setPrice2((TextView) convertView.findViewById(R.id.myapp_downloaded_price2));			
			holder.setSize1((TextView) convertView.findViewById(R.id.myapp_downloaded_size1));
			holder.setSize2((TextView) convertView.findViewById(R.id.myapp_downloaded_size2));
			holder.setDcount1((TextView) convertView.findViewById(R.id.myapp_downloaded_dcount1));
			holder.setDcount2((TextView) convertView.findViewById(R.id.myapp_downloaded_dcount2));
			holder.setPcount1((TextView) convertView.findViewById(R.id.myapp_downloaded_pcount1));
			holder.setPcount2((TextView) convertView.findViewById(R.id.myapp_downloaded_pcount2));
			holder.setRating1((RatingBar) convertView.findViewById(R.id.myapp_downloaded_rating1));
			holder.setRating2((RatingBar) convertView.findViewById(R.id.myapp_downloaded_rating2));
			holder.setScore1((TextView) convertView.findViewById(R.id.myapp_downloaded_score1));
			holder.setScore2((TextView) convertView.findViewById(R.id.myapp_downloaded_score2));			
			holder.setAction1((LinearLayout) convertView.findViewById(R.id.myapp_downloaded_action1));
			holder.setAction2((LinearLayout) convertView.findViewById(R.id.myapp_downloaded_action2));
			holder.setText1((TextView) convertView.findViewById(R.id.myapp_downloaded_text1));
			holder.setText2((TextView) convertView.findViewById(R.id.myapp_downloaded_text2));
			holder.setDel1((LinearLayout) convertView.findViewById(R.id.myapp_downloaded_del1));
			holder.setDel2((LinearLayout) convertView.findViewById(R.id.myapp_downloaded_del2));
			convertView.setTag(holder);						
		} else			
			holder = (ViewHolderMyAppDownloaded) convertView.getTag();
		...
		switch (entityApp1.getStatus()) {
			case NOINSTALL:				
				text = mContext.getString(R.string.app_continue);
	...
	public void onClick(View v) {
		...
		switch (id) {
			case R.id.myapp_downloaded_del1:
			case R.id.myapp_downloaded_del2: {
